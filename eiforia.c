...
int main(int argc, char *argv[])
{
    ...
    // mvwprintw(stdscr,0,5,"Kingdom Eiforia, F12 to exit");

    // int x, y;
    // getmaxyx(stdscr, y, x);
    // cursed *menu_window = tui_new_win(4, x/4, y/2, x/2, "Main menu", 10);
...
void prn_sost(long god)
{
    ...
    {
        printf("---------------------------------------------------------------------------------\n");
        printf("                   Состояние Ваших дел на %li-й год правления.", god);
    }
...
/*                printf("\n\nНажмите любую клавишу...");
        ...
        else
        {
            ...
            if (n < 30)
            {
                printf("\n\nЕсть возможность объявить войну одному из соседей.\nОбъявляете? (y/n) ==> ");
                n = get_choice();
                if (n == 1)
                {
                    begin_war();
...
*/
    ...
    printf("ностью, обратно пропорциональной выделенной норме, может произойти буннт, и\n");
 ...
 */
    ...
    printf("ней...\n");
    printf("                              Originally written by Ponpa Dmitriy, 41PDM. 1998.\n");
    printf("                                         Adapted for Linux by Niimailtah. 2014.\n");
    printf("-------------------------------------------------------------------------------\n");
/*
    printf("Для продолжения нажмите Enter.\n");
    printf("\n");
